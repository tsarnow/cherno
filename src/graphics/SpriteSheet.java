...
public class SpriteSheet {
	...
	public static final SpriteSheet tiles = new SpriteSheet("/textures/grid.png", 256, -65281);
	public static final SpriteSheet spawn_level = new SpriteSheet("/textures/spawn_level.png", 48, 0);
	public static final SpriteSheet projectile_wizard = new SpriteSheet("/textures/projectile.png", 48, -65281);
	
	public static final SpriteSheet player = new SpriteSheet("/textures/player.png", 160, 128, -327425);
	...
	public static final SpriteSheet dummy = new SpriteSheet("/textures/pokemon/poke_player.png", 256, 256, -327425);
	...
	public SpriteSheet(SpriteSheet sheet, int x, int y, int width, int height, int spriteSize) {
		...
		HEIGHT = h;
		pixels = new int[w * h];
		TRANSPARENT_COLOR = sheet.TRANSPARENT_COLOR;
		...
		for (int ya=0; ya < height; ya++) {
			for (int xa=0; xa < width; xa++) {
				...
				Sprite sprite = new Sprite(spriteSize, spriteSize, spritePixels, TRANSPARENT_COLOR);
	...
	public SpriteSheet(String path, int size, int transparentColor) {
		this.path = path;
		this.SIZE = size;
		WIDTH = size;
		HEIGHT = size;
	...
	public SpriteSheet(String path, int width, int height, int transparentColor) {
		this.path = path;
